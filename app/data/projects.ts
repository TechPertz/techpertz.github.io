...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: ["Developed a web application using Django and React to classify Amazon product reviews into positive, neutral, and negative sentiments while extracting key keywords.",
    ...
    tags: ["Python", "Django", "Django Rest Framework", "React", "MySQL", "spaCy (Pre-built-NLP)"],
    domain: ["Cloud"],
  ...
  },
  {
    ...
    description: ["Developed a feature-rich Telegram Bot in Python with 7 automated functionalities, managing transactions for 500+ customers and efficiently querying MySQL across 5 relational tables.",
    ...
    tags:["Django", "React", "React", "Telegram Bot API", "REST API", "JWT Authentication", "Role-Based Access Control"],
    domain: ["DevOps"],
  ...
  },
  {
    ...
    description: ["Built a location-based web application using Django and React, implementing a REST API with authentication through Django Rest Framework (DRF).",
    ...
    tags:["React", "Django", "Django Rest Framework", "GeoDjango", "PostGIS", "Spatial Data Modeling", "REST API", "Authentication"],
    domain: ["DevOps"],
    link: "https://github.com/yourusername/dummy-project-5",
    isLinkClickable: true,
    linkText: "View on GitHub",
